...
const AddBranch = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setIsLoading(true);
    try {
      // API call to create branch using the service
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <div className="mb-6">
        ...
        <p className="text-gray-600 mt-2">Create a new branch for your laundry business</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="bg-white rounded-lg border shadow-sm p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              />
              {errors.opening_date && <p className="text-red-500 text-sm mt-1">{errors.opening_date}</p>}
            </div>
        ...
        <div className="bg-white rounded-lg border shadow-sm p-6">
          ...
          <div className="grid grid-cols-1 gap-6">
            <div>
              ...
              />
              {errors.branch_manager && <p className="text-red-500 text-sm mt-1">{errors.branch_manager}</p>}
              <p className="text-gray-500 text-sm mt-1">
                Note: You can assign a specific user as branch manager later from the branch managers section.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center justify-end gap-4 pt-6">
          ...
          >
            <FaSave /> {isLoading ? 'Creating...' : 'Create Branch'}
          </button>
        </div>
      </form>
    </div>
