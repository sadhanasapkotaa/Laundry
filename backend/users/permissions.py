...
class IsBranchManager(BasePermission):
    ...
    def has_permission(self, request, view):
        return request.user.is_authenticated and request.user.role == User.Role.BRANCH_MANAGER
...
class IsAdminOrBranchManager(BasePermission):
    ...
    def has_permission(self, request, view):
        return (request.user.is_authenticated and
                request.user.role in [User.Role.ADMIN, User.Role.BRANCH_MANAGER])
...
class CanManagePickups(BasePermission):
    ...
    def has_permission(self, request, view):
        return request.user.is_authenticated and request.user.role in [
            User.Role.ADMIN, User.Role.BRANCH_MANAGER, User.Role.RIDER
        ]
